...
export interface OptimizationInfo {
  ...
  strategy: 'none' | 'statistical-sampling' | 'lod-sampling' | 'adaptive-sampling' | 'time-bucket-aggregation' | 'sliding-window' | 'database-optimized' | 'time-aligned-sampling' | 'intersection-based-sampling' | 'boundary-preserved-sampling';
}
